...
#gather arguments
parser = argparse.ArgumentParser(description='Extract per-language lemma list from zim file.')
parser.add_argument('-zimfile',action='store',dest='zimfile',help='Location of ZIM file.')
parser.add_argument('-langfile',action='store',dest='langfile',help='List of languages.')
